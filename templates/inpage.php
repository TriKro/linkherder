...
<p>Last update: <?= $kws_options['last_update']? date('Y-m-d H:i', $kws_options['last_update']).", {$inpage_total_keywords} keywords" : 'Never'?> <span><input class="button" type="submit" value="Update now" onclick="window.location = '<?= LINKHERDER_ADMIN_URL ?>' + '&kws_action=update_now_inpage'; this.parentNode.innerHTML = 'Updating... Please wait...'" /></span></p>
...
<span class="edit"><a target="_blank" href="post.php?post=<?= $item['post_id'] ?>&amp;action=edit" title="Edit this page">Edit Page</a> |</span>
	<span class="trash"><a class="submitdelete" title="Blacklist keyword" href="<?= LINKHERDER_ADMIN_URL ?>&kws_action=inpage_form&inpage_action=blacklist&keyword[]=<?= $item['id'] ?>">Blacklist Keyword</a> |
	</span>
	<span class="trash"><a href="<?= LINKHERDER_ADMIN_URL ?>&kws_action=inpage_form&inpage_action=detach&keyword[]=<?= $item['id'] ?>" title="Detach keyword from this URL" rel="permalink">Detach from this URL</a></span>
</div>
</td>			
